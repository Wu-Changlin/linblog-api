...
use App\Http\Requests\Backend\AddOrEditConfigurationRequest;
...
class ConfigurationController extends Controller
{
    ...
    public function addOrConfiguration(AddOrEditConfigurationRequest $request)
    {
        ...
        // "user_id": 0,
        // "nick_name": "Lin",
        // "email": "840832887@qq.com",
        // "avatar": "",
        // "password": "b334be2e4dda3fa6ae58fb7e8367755ac3908f29bdfd663ab541ff45c774bad9",
        // "confirm_password": "b334be2e4dda3fa6ae58fb7e8367755ac3908f29bdfd663ab541ff45c774bad9",
        // "role": 2,
        // "is_enable": 1,
        // "action": "add",
        $request_params_all_data = $request->all();
        ...
        $add_or_edit_user_data['nick_name'] = $request_params_all_data['nick_name'];
        $add_or_edit_user_data['email'] = $request_params_all_data['email'];
        $add_or_edit_user_data['avatar'] = $request_params_all_data['avatar'];
        $add_or_edit_user_data['password'] = $request_params_all_data['password'];
        $add_or_edit_user_data['confirm_password'] = $request_params_all_data['confirm_password'];
        $add_or_edit_user_data['role'] = $request_params_all_data['role'];
        $add_or_edit_user_data['is_enable'] = $request_params_all_data['is_enable'];

        //执行添加
        if ($request_params_all_data['action'] === 'add') {
            // 添加  返回  true 成功  ， 错误消息或false 失败
            $add_or_edit_user_result = UserService::addUser($add_or_edit_user_data);
        }
