...
/* 检查请求是否携带access_token和有效期 */

class CheckTokenInBackendModular
{
    // 状态 关闭：false，开启：true
    ...
    public function handle(Request $request, Closure $next)
    {
         ...
         if (self::$status == true) {
            ...
            if ($authorizationHeader) {
                ...
                // 验证令牌名称的有效时间
                $verify_token_name_time_to_live_result = JsonWebTokenService::verifyTokenNameTimeToLive('access_token', $time_to_live);
